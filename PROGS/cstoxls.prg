...
*Setting the title
RangeString = xlsheet.cells(1,FldCnt+2).address
...
xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.cells(2,10).value = "基本工资增资"
...
xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.cells(2,14).value = "年终奖增资因素"
...
xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.cells(2,15).value = "加年终奖后净增资"
...
xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.cells(2,16).value = "绩效实际减少"
...
xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.cells(2,17).value = "新绩效工资标准"
...
xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.cells(2,18).value = "调整后最终标准"
...
xlSheet.Columns("N:N").EntireColumn.AutoFit
xlSheet.Columns("O:O").EntireColumn.AutoFit
xlSheet.Columns("P:P").EntireColumn.AutoFit
xlSheet.Columns("Q:Q").EntireColumn.AutoFit
xlSheet.Columns("R:R").EntireColumn.AutoFit
...
xlSheet.cells(3,11).value = "原绩效水平"
xlSheet.cells(3,12).value = "减少额"

*set the border's style and align mode
RangeString = xlsheet.cells(RecCnt+StartRow-2,FldCnt+2).address
...
*xlSheet.range(RangeString).HorizontalAlignment = 3
xlSheet.range(RangeString).VerticalAlignment = 2
xlSheet.range(RangeString).Rowheight=16.25
