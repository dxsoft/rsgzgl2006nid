  ...
  String sql = """
      WITH typed AS (
        SELECT CONCAT(TRIM(t.dwbm), '-', TRIM(t.grbm)) person_code,
               ...
               CASE
                 WHEN TRIM(t.jslb) IN ('\u8b66\u8854\u53d8\u5316', '\u8b66\u8854\u6d25\u8d34') THEN 'police'
                 WHEN TRIM(t.jslb) IN ('\u8b66\u5458\u5957\u6539', '\u804c\u7ea7\u5957\u6539', '\u804c\u7ea7\u664b\u5347') THEN 'civil-rank'
                 WHEN TRIM(t.jslb) IN ('\u6cd5\u5b98\u7b49\u7ea7', '\u68c0\u5bdf\u7b49\u7ea7', '\u5ba1\u5224\u6d25\u8d34', '\u68c0\u5bdf\u6d25\u8d34') THEN 'judicial-allowance'
               END type_key
        FROM hisbase t
...
if (-not $rawRows) {
    throw "No rank/judicial candidate rows were exported from the database."
}
...
$selectedByType = @{
    "police" = New-Object System.Collections.Generic.List[object]
    "civil-rank" = New-Object System.Collections.Generic.List[object]
    "judicial-allowance" = New-Object System.Collections.Generic.List[object]
}
...
foreach ($typeKey in @("police", "civil-rank", "judicial-allowance")) {
